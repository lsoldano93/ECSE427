 ...
 * reduce this value.
 */
#define MAX_BYTES 2560 /* Maximum file size I'll try to create */
#define MIN_BYTES 512         /* Minimum file size */

/* Just a random test string.
 */
static char test_str[] = "I got a glock in my 'rari.\n";
